...
\begin{equation}
\label{eq:sgd}
	T( \boldsymbol{\theta}| L,\mathbf{X},  \mathbf{y},  \mathbf{h}, \boldsymbol{\beta_{\text{lr}}}) = \boldsymbol{\theta} - \beta_{\text{lr}} \nabla L( \boldsymbol{\theta}, \mathbf{h}, \mathbf{X}, \mathbf{y}), 
\end{equation}
...
\begin{equation}
\label{eq:ineq}
\beta_{\text{lr}}<\frac{1}{C_L}, \quad \beta_{\text{lr}} < \bigl(\max_{g \in \{1,\dots,r\}}\lambda_\textnormal{max} (\mathbf{H}(\mathbf{w}^l))\bigr)^{-1}, 
\end{equation}
...
\begin{equation}
\label{eq:to_taylor}
	\textnormal{log}~\left|\frac{\partial{T(\mathbf{w}'^l)}}{\partial{\mathbf{w}}}\right| = \textnormal{log}~|\mathbf{I} - \beta_{\text{lr}}\mathbf{H}| = \sum_{i=1}^{u} \textnormal{log}~(1-\beta_{\text{lr}}\lambda_i),
\end{equation}
...
\[
	 \sum_{t=1}^{u} \textnormal{log}~(1-\beta_{\text{lr}}\lambda_i) =  -\beta_{\text{lr}} \textnormal{Tr}[\mathbf{H}(\mathbf{w}'^l)] - \beta_{\text{lr}}^2 \textnormal{Tr}[\mathbf{H}(\mathbf{w}'^l)\mathbf{H}(\mathbf{w}'^l)] + o_{\beta_{\text{lr}}^2 \to 0}(1).
\]
...
\begin{equation}
\label{eq:langevin}
	T(\mathbf{w}) = \mathbf{w} -  \beta_{\text{lr}} \nabla L -\frac{m}{\hat{m}}\textnormal{log}p(\hat{\mathbf{y}}|\hat{\mathbf{X}}, \mathbf{w},\mathbf{h}) + \boldsymbol{\varepsilon}, \quad  \boldsymbol{\varepsilon} \sim \mathcal{N}(\mathbf{0}, {\frac{\beta_{\text{lr}}}{2}}\mathbf{I}),
\end{equation}
