...
$$\Loss = \Val \propto $$ $$\E_{\q} \log \LL - \KL{\q}{\prior} + \log\priorh,$$ что и требовалось доказать.
TODO 
...
Достаточным условием непрерывности функций вида $\KL{p_1}{p_2}$ является непрерывность по метапараметрам функций $p_1 (\log{p_1} - \log{p_2})$  почти всюду. TODO  
