...
Рассмотрим второй случай. Пусть $\boldsymbol{\gamma} = \frac{1}{K}$.
Тогда выражение~\eqref{eq:gs} с точностью до множителя упрощается до $\lambda^{K-1}$. Предел данного выражения стремится к бесконечности.
