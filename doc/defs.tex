...
\newcommandx{\prior}[4][1=\mathbf{w},2=\boldsymbol{\Gamma},3=\mathbf{h},4=\boldsymbol{\lambda}]{p(#1,#2|#3,#4)}
\newcommand{\priorh}{p(\mathbf{h}|\boldsymbol{\lambda})}
\newcommand{\priorG}{p(\boldsymbol{\Gamma}|\mathbf{h},\boldsymbol{\lambda})}
...
\newcommand{\q}{q(\mathbf{w}, \boldsymbol{\Gamma}|\boldsymbol{\theta})}
\newcommand{\qG}{q_{\boldsymbol{\Gamma}}(\boldsymbol{\Gamma}|\boldsymbol{\theta}_{\boldsymbol{\Gamma}})}
\newcommand{\qw}{q_\mathbf{w}(\mathbf{w}| \boldsymbol{\Gamma}, \boldsymbol{\theta}_\mathbf{w})}
...
\newcommand{\Val}{Q(\mathbf{h}|\mathbf{y},\mathbf{X}, \boldsymbol{\theta},\boldsymbol{\lambda})}
